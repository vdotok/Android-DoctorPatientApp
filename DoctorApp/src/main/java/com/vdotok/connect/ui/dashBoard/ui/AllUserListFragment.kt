...
import com.vdotok.connect.databinding.LayoutAllUserListBinding
import com.vdotok.connect.dialogs.CreateGroupDialog
import com.vdotok.connect.extensions.*
import com.vdotok.connect.models.CreateGroupModel
import com.vdotok.connect.models.GetAllUsersResponseModel
import com.vdotok.connect.models.UserModel
...
import com.vdotok.connect.ui.dashBoard.adapter.AllUserListAdapter
import com.vdotok.connect.ui.dashBoard.adapter.OnInboxItemClickCallbackListner
